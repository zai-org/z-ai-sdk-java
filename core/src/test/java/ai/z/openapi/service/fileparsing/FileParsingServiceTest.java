...
/**
 * FileParsingService test class for testing various functionalities of FileParsingService and
...
public class FileParsingServiceTest {
    ...
    void testGetParseResult() throws JsonProcessingException {
        ...
        logger.info("File parsing result: taskId={}, response={}", taskId,
                mapper.writeValueAsString(downloadResp));
    }
