...
public class FineTuningJob {
	...
	/**
	 * The name of the fine-tuned model that is being created. Can be null if no
	 * fine-tuned model is created yet.
	 */
	...
	/**
	 * The current status of the fine-tuning job. Can be either created, pending, running,
