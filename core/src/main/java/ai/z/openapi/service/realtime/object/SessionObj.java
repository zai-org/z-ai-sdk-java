 ...
 * This object contains all the settings and parameters for a realtime session,
 * including model configuration, audio settings, tools, and other session parameters.
 */
@Getter
@Setter
