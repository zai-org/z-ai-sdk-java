...
public interface FineTuningService {
     ...
     * 
     * @param queryPersonalFineTuningJobRequest the request parameters for listing personal jobs
     * @return QueryPersonalFineTuningJobApiResponse containing the list of personal fine-tuning jobs
     */
    QueryPersonalFineTuningJobApiResponse listPersonalFineTuningJobs(QueryPersonalFineTuningJobRequest queryPersonalFineTuningJobRequest);
