...
public class FineTuningServiceImpl implements FineTuningService {
    ...
    @Override
    public QueryFineTuningEventApiResponse listFineTuningJobEvents(QueryFineTuningJobRequest queryFineTuningJobRequest) {
        RequestSupplier<QueryFineTuningJobRequest, FineTuningEvent> supplier = (params) -> fineTuningApi.listFineTuningJobEvents(
                params.getJobId(),
                params.getLimit(),
                params.getAfter()
        );
        return this.zAiClient.executeRequest(queryFineTuningJobRequest, supplier, QueryFineTuningEventApiResponse.class);
    }
    
    @Override
    public QueryFineTuningJobApiResponse retrieveFineTuningJob(QueryFineTuningJobRequest queryFineTuningJobRequest) {
        RequestSupplier<QueryFineTuningJobRequest, FineTuningJob> supplier = (params) -> fineTuningApi.retrieveFineTuningJob(
                params.getJobId(),
                params.getLimit(),
                params.getAfter()
        );
    ...
    @Override
    public QueryPersonalFineTuningJobApiResponse listPersonalFineTuningJobs(QueryPersonalFineTuningJobRequest queryPersonalFineTuningJobRequest) {
        RequestSupplier<QueryPersonalFineTuningJobRequest, PersonalFineTuningJob> supplier = (params) -> fineTuningApi.queryPersonalFineTuningJobs(
                params.getLimit(),
                params.getAfter()
        );
        return this.zAiClient.executeRequest(queryPersonalFineTuningJobRequest, supplier, QueryPersonalFineTuningJobApiResponse.class);
    }
    
    @Override
    public QueryFineTuningJobApiResponse cancelFineTuningJob(FineTuningJobIdRequest fineTuningJobIdRequest) {
        RequestSupplier<FineTuningJobIdRequest, FineTuningJob> supplier = (params) -> fineTuningApi.cancelFineTuningJob(params.getJobId());
    ...
    public QueryFineTuningJobApiResponse deleteFineTuningJob(FineTuningJobIdRequest fineTuningJobIdRequest) {
        RequestSupplier<FineTuningJobIdRequest, FineTuningJob> supplier = (params) -> fineTuningApi.deleteFineTuningJob(params.getJobId());
        return this.zAiClient.executeRequest(fineTuningJobIdRequest, supplier, QueryFineTuningJobApiResponse.class);
    }
    
    @Override
    public FineTunedModelsStatusResponse deleteFineTunedModel(FineTuningJobModelRequest fineTuningJobModelRequest) {
        RequestSupplier<FineTuningJobModelRequest, FineTunedModelsStatus> supplier = (params) -> fineTuningApi.deleteFineTuningModel(params.getFineTunedModel());
