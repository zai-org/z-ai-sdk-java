 ...
 * This service provides methods for creating, deleting, and listing voice clones.
 */
public interface VoiceCloneService {

    /**
     * Creates a new voice clone based on the provided audio sample and parameters.
     * @param request the voice clone creation request containing voice name, sample audio text, 
     *                target text, and audio file information
     ...
     * @param request the voice list request containing optional voice type and name filters
