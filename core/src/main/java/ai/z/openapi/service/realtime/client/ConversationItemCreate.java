 ...
 * This event allows adding messages, function calls, or function responses to the conversation context.
 */
@Getter
@Setter
...
public class ConversationItemCreate extends RealtimeClientEvent {
    /**
     * The ID of the item after which the new item should be inserted.
     * If null, the item will be appended to the end of the conversation.
     */
