...
public class DocumentServiceImpl implements DocumentService {
    ...
    public DocumentEditResponse modifyDocument(DocumentEditParams request) {
        RequestSupplier<DocumentEditParams, Response<Void>> supplier = (params) ->
                documentApi.modifyDocument(params.getId(), params);
    ...
    public DocumentEditResponse deleteDocument(String documentId) {
        ...
        RequestSupplier<DocumentEditParams, Response<Void>> supplier = (params1) ->
                documentApi.deleteDocument(params1.getId());
    ...
    public QueryDocumentApiResponse listDocuments(QueryDocumentRequest request) {
        RequestSupplier<QueryDocumentRequest, DocumentPage> supplier = (params) ->
    ...
    public DocumentDataResponse retrieveDocument(String documentId) {
        DocumentEditParams params = new DocumentEditParams();
        params.setId(documentId);
        RequestSupplier<DocumentEditParams, DocumentData> supplier = (id) ->
                documentApi.retrieveDocument(id.getId());
