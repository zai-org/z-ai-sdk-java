...
public class WebSearchRequest implements ClientRequest<WebSearchRequest> {
    ...
    /**
     * Passed by client, must ensure uniqueness; used to distinguish unique identifier for each request, platform will generate by default if not provided by client.
     */
