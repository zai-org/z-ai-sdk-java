 ...
 * This interface defines a contract for operations that take a parameter
 * and return data that can be processed in a reactive stream.
 * 
...
public interface FlowableRequestSupplier<Param, Data> {
     ...
     * This method is designed to be used in reactive programming contexts
     * where the returned data can be processed as a stream.
     * 
