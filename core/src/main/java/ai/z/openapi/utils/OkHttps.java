 ...
 * This class provides factory methods to create properly configured HTTP clients
 * with authentication, timeouts, and connection pooling based on Z.AI configuration.
 * 
...
public final class OkHttps {
     ...
     * - Configured timeouts (call, connect, read, write)
     * - Connection pooling
     * 
    ...
    private static void configureConnectionPool(OkHttpClient.Builder builder, ZAiConfig config) {
        ConnectionPool connectionPool = new ConnectionPool(
                ...
                config.getConnectionPoolTimeUnit()
        );
