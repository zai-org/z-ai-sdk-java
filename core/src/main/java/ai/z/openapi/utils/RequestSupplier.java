 ...
 * This interface defines a contract for asynchronous operations that take a parameter
 * and return a Single<Data> for reactive programming.
 * 
...
public interface RequestSupplier<Param, Data> {
     ...
     * Returns a Single that emits exactly one item or an error.
     * 
